...
ENTROPY_COEFF = 0.45  # Entropy regularisation coefficient
LR = 0.000005
POLICY_COEFF = 0.2
RMS_EPSILON = 1e-08
RMS_ALPHA = 0.99
...
class CNNBase(NNBase):
    def __init__(self, num_inputs, recurrent=True, hidden_size=1024):
        ...
        self.fc1 = NoisyLinear((67 + 3) * ENV_DIM * ENV_DIM * ENV_DIM, 1024)
        self.critic_linear = NoisyLinear(hidden_size * 2, 1)
        self.actor_linear = NoisyLinear(hidden_size * 2, NUM_ACTION)
        self.train()
